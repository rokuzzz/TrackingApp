...
import com.example.trackingapp.other.Constants.NOTIFICATION_CHANNEL_ID
import com.example.trackingapp.other.Constants.NOTIFICATION_CHANNEL_NAME
...
class TrackingService : LifecycleService() {
    ...
    private fun startForegroundService() {
        ...
        if(Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            createNotificationChammel(notificationManager)
        }
    ...
    private fun createNotificationChammel(notificationManager: NotificationManager) {
